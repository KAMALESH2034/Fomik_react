    ...
    <div class="container ">
       <div class="row">
         ...
         <div class="col-12 col-lg-5 mt-5 mb-8 mb-lg-0">
           ...
           <div class="mx-auto bg-white rounded-4 text-center shadow-lg">
                ...
                <button type="button" onClick={()=>{navigate(-1)}} className='btn btn-primary mt-3 mb-4 fw-bold' > Submit new response</button>
            </div>
           </div>
         </div>
